			...
			<CssBaseline />
				...
				<Toolbar>
					<Typography variant="h6"  className={classes.title}>
						<Link to="/home" className={classes.link}> MOVIE APP</Link>
					</Typography>
					...
					<Button color="inherit" onClick={e => gotToProfile(e, '/user')} endIcon={<AccountCircleIcon />}>Contact</Button> 
